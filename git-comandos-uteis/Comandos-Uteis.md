...
git config --global user.email "seu email aqui"identifica o email do usuario

git config --global user.name "seu nickname"identifica o usuario
...
git push -u origin masterenvia arquivos / diretorios para o repositorio remoto
